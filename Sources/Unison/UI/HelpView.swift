        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 16) {
                ...
                section("Playing through several devices",
                    "Unison appears in the sound output list as a device of its own. While Unison is selected, the sound your Mac plays is captured, using the System Audio Recording permission, and redistributed to every device ticked under Play through in Settings. In Spatial mode, each speaker can be placed where it physically sits, from full left to full right, and the macOS spatial mixer renders the matching part of the stereo field to it. In Stereo mode, every device keeps its natural stereo.")
